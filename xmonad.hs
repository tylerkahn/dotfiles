...
--
myWorkspaces    = ["vim","doc","term","goog","5","6","7","8","music"]
...
--    , ((modm .|. shiftMask, xK_q     ), io (exitWith ExitSuccess))
    ...
    -- Logout
    , ((modm .|. shiftMask, xK_q     ), spawn "gnome-session-quit --logout") -- "xmonad --recompile; xmonad --restart")
...
getWellKnownName dbus = tryGetName `catch` (\ (DBus.Error _ _) ->
